...
describe 'hp_mcp::params', :type => :class do
  ...
  describe "when used on supported operatingsystem" do
    operatingsystems = ['CentOS', 'OracleLinux']
    operatingsystems.each do |os|
      describe os do
        ...
        it "should not fail" do
          subject.should contain_class("hp_mcp::params")
        end
        ...
        pending 'each parameter must be set' do
          ...
          # hp_mcp::params, defining parameters that map to each params
