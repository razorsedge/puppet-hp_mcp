# == Class: hp_mcp::hpsnmp
#
# This class handles installation of the HP Management Component Pack SNMP
# Agent.
#
# === Parameters:
#
...
class hp_mcp::hpsnmp (
  ...
  case $::manufacturer {
    'HP': {
      #Class['hp_mcp'] -> Class['hp_mcp::repo'] -> Class['hp_mcp::snmp'] ->
      #Class['hp_mcp::hphealth'] -> Class['hp_mcp::hpsnmp']
